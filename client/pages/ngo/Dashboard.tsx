...
export default function NGODashboard() {
  ...
  return (
    <DashboardLayout userRole="ngo" userName="NGO Admin" organizationName={organizationName}>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">{organizationName} Dashboard</h1>
          ...
          <CardContent>
            {upcomingEvents.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">Create your first event to start engaging your community</p>
                <Button className="bg-primary hover:bg-primary/90">
                  <Plus className="w-4 h-4 mr-2" />
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`font-medium ${getStatusColor(event.registeredParticipants, event.maxParticipants)}`}>
                        ...
                        <span className="text-sm text-muted-foreground">
                          {getParticipationPercentage(event.registeredParticipants, event.maxParticipants)}% full
                        </span>
                      </div>
                    </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Create and edit your environmental events</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Manage your eco-community members</p>
                </div>
                <ArrowRight className="w-5 h-5 text-muted-foreground" />
              </div>
            </CardContent>
          ...
          <Card className="border-0 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-foreground mb-1">Rewards Store</h3>
                  <p className="text-sm text-muted-foreground">Manage environmental rewards</p>
                </div>
                <ArrowRight className="w-5 h-5 text-muted-foreground" />
              </div>
            </CardContent>

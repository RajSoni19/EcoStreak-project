...
export default function Leaderboard() {
  ...
  const communities: Community[] = [
    ...
    },
    {
      ...
      totalPoints: 28940,
      memberCount: 143,
      ngoName: "Green Power Initiative",
      change: "down",
    },
    {
      rank: 8,
    ...
    {
      rank: 10,
      name: "Carbon Neutrals",
      totalPoints: 22340,
      memberCount: 134,
      ngoName: "Carbon Zero Network",
      change: "down",
    },
  ];
  ...
  const getRankBadgeColor = (rank: number) => {
    ...
    if (rank <= 10)
      return "bg-gradient-to-r from-eco-forest to-eco-leaf text-white";
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            See how you stack up against eco-warriors worldwide and in your
            communities
          </p>
        </div>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p
                              className={`font-semibold ${user.isCurrentUser ? "text-eco-forest" : "text-foreground"}`}
                            >
                              {user.name}
                              {user.isCurrentUser && (
                                <Badge
                                  variant="outline"
                                  className="ml-2 text-xs bg-eco-forest/10 text-eco-forest border-eco-forest/30"
                                >
                                  You
                                </Badge>
                              )}
                      ...
                      <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-bold text-eco-sage">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {community.rank <= 3 && (
                            <Badge
                              className={getRankBadgeColor(community.rank)}
                            >
                              #{community.rank}
                            </Badge>
                          )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-1 mt-1">
                    ...
                    <span className="text-xs text-eco-forest">
                      +3 this week
                    </span>
                  </div>
                </div>
